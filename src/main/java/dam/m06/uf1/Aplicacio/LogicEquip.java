...
public class LogicEquip {
    ...
    /**
     * Verifica les regles de negoci abans de retornar els equips i els jugadors.
    ...
    /**
     * Verifica si hi ha registres i lalvors exporta dades a XML
     * En cas contrarim genera una excepció informant del problema
     * @param fitx
     * @param dades
     * @throws AplicacioException 
     */
    ...
    /**
     * Valida que existeixin equips a exportar a CSV i els exporta
     * En cas contrari, genera una excepció
